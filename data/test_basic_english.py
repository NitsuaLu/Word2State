"""
验证 loader_basic_english.py（basic_english 版）的各项功能。
用法：python data/test_basic_english.py
"""
...
import torch
from data.loader_basic_english import (
...
def test_build_cbow_windows():
    ...
    assert len(build_cbow_windows("a b c d e f g h i j")) == 2
...
if __name__ == "__main__":
    print("=== loader_basic_english.py 测试 ===\n")
    test_tokenize()
